        ...
        <SidebarContainer>
          ...
          <ActionList>
            <ActionButton onClick={() => {
              window.location = "http://192.168.1.4:5000"
            }}>
              <ActionIcon>
                <svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
        ...
        <ContentContainer>
          ...
          <AiDesignPromo>
            <PromoContent>
              ...
              <Link to="/ai-design">
                <PromoButton>Try AI Design</PromoButton>
              </Link>
            </PromoContent>
            <PromoImage src="/assets/ai-design-promo.jpg" alt="AI Design Tool" />
          </AiDesignPromo>
        </ContentContainer>
      </MainContent>
    </DashboardContainer>
